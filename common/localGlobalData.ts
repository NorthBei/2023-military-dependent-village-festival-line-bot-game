...
export const ASSETS_PREFIX = '/bot/assets/';

const LEVEL_ASSETS_PREFIX = `${ASSETS_PREFIX}關卡/`;
  ...
  levels: [
    {
      ...
      password: '戀戀風塵',
      errorMessage: [textMessage('你要不要再看清楚一點？')],
      successMessage: () => [
        textMessage('太厲害啦！\n沒想到勇者也有這麼文藝的一面呢。\n\n🀄 恭喜獲得「老同學電影館」麻將'),
    ...
    },
    {
      ...
      password: '串珠子',
      errorMessage: [textMessage('如果媽媽跟你一樣算錯可就虧大了。')],
      successMessage: (data) => [
        textMessage('答對啦！\n🀄 恭喜獲得「我家裁縫店」麻將'),
    ...
    },
    {
      ...
      password: '136',
      errorMessage: [textMessage('看來你的品味與眾不同喔。')],
      successMessage: (data) => [
        textMessage('答對了！\n趕快進書店看看有沒有感興趣的作品吧。\n\n🀄 恭喜獲得「白鹿亂撞租書店」麻將'),
    ...
    },
    {
      ...
      password: '李太太',
      errorMessage: [textMessage('這種程度在村子裡是上不了牌桌的～')],
      successMessage: () => [
        textMessage('不錯喔，下次一起摸幾圈吧。\n🀄 恭喜獲得「麻將桌」麻將'),
    ...
    },
    {
      ...
      password: '169',
      errorMessage: [textMessage('注意看顏色和車款')],
      successMessage: (data) => [
        textMessage('答對啦！\n🀄 恭喜獲得「計程車」麻將'),
    ...
    },
    {
      ...
      successMessage: (data) => [
        ...
        imageMessage(`${LEVEL_MAHJONG_ASSETS_PREFIX}/關卡7_知識補充.jpg`)
      ]
    },
    {
      id: '8',
      ...
      successMessage: (data) => [
        ...
        imageMessage(`${LEVEL_ASSETS_PREFIX}/關卡8_知識補充.jpg`)
      ]
    },
    {
      id: '9',
      ...
      content: {
        [RandomLevelClassified.A]: [
          ...
          audioMessage(`${LEVEL_SOUND_ASSETS_PREFIX}關卡9-題目音檔-1.mp3`, 12000)
        ],
        [RandomLevelClassified.B]: [
          textMessage(
            '🕹️ 抵達「小涼亭」\n\n眷村裡的老歌，小孩一聽前奏就知道是哪一首。其中深受男女老少喜愛的鄧麗君，也是在隔壁蘆洲的眷村裡長大的呢。\n\n📜 下面會播放一首經典老歌的前奏，你能猜得出來是桌上哪一首歌嗎？'
          ),
          audioMessage(`${LEVEL_SOUND_ASSETS_PREFIX}關卡9-題目音檔-2.mp3`, 12000)
        ],
        [RandomLevelClassified.C]: [
          textMessage(
            '🕹️ 抵達「小涼亭」\n\n眷村裡的老歌，小孩一聽前奏就知道是哪一首。其中深受男女老少喜愛的鄧麗君，也是在隔壁蘆洲的眷村裡長大的呢。\n\n📜 下面會播放一首經典老歌的前奏，你能猜得出來是桌上哪一首歌嗎？'
          ),
          audioMessage(`${LEVEL_SOUND_ASSETS_PREFIX}關卡9-題目音檔-3.mp3`, 12000)
        ],
        [RandomLevelClassified.D]: [
          textMessage(
            '🕹️ 抵達「小涼亭」\n\n眷村裡的老歌，小孩一聽前奏就知道是哪一首。其中深受男女老少喜愛的鄧麗君，也是在隔壁蘆洲的眷村裡長大的呢。\n\n📜 下面會播放一首經典老歌的前奏，你能猜得出來是桌上哪一首歌嗎？'
          ),
          audioMessage(`${LEVEL_SOUND_ASSETS_PREFIX}關卡9-題目音檔-4.mp3`, 12000)
        ],
        [RandomLevelClassified.E]: [
          textMessage(
            '🕹️ 抵達「小涼亭」\n\n眷村裡的老歌，小孩一聽前奏就知道是哪一首。其中深受男女老少喜愛的鄧麗君，也是在隔壁蘆洲的眷村裡長大的呢。\n\n📜 下面會播放一首經典老歌的前奏，你能猜得出來是桌上哪一首歌嗎？'
          ),
          audioMessage(`${LEVEL_SOUND_ASSETS_PREFIX}關卡9-題目音檔-5.mp3`, 12000)
        ]
      },
      password: {
      ...
      errorMessage: [textMessage('先去點播鄧麗君串燒再來挑戰吧。')],
      successMessage: (data) => [
        textMessage('答對了！一村K歌之王是你～\n🀄 恭喜獲得「小涼亭」麻將'),
        imageMessage(`${LEVEL_MAHJONG_ASSETS_PREFIX}/LINE關卡圖片_麻將-麥克風.png`),
        textMessage(
          '⭐{monsterName}要補充！\n\n你現在在的地方曾經搭了個鐵皮屋，電視、冰箱、瓦斯爐、伴唱機一應具全，大家沒事就泡在這裡唱歌、聊天，還把這裡當「共享廚房」，一起下麵吃，熱熱鬧鬧享受相聚的時光。',
          data
        ),
        imageMessage(`${LEVEL_ASSETS_PREFIX}/關卡9_知識補充.jpg`)
      ]
    },
    {
      id: '10',
    ...
    },
    {
      ...
      password: '茄冬老樹',
      errorMessage: [textMessage('他是什麼樣的樹呢？')],
      successMessage: (data) => [
        textMessage('沒錯！朱將軍和大樹將軍之間的情誼真讓人動容呢。\n🀄 恭喜獲得「大樹將軍」麻將'),
    ...
    },
    {
      ...
      content: [
        ...
        imageMessage(`${LEVEL_ASSETS_PREFIX}麵粉題.jpg`)
      ],
      password: '酒釀湯圓',
    ...
    },
    {
      ...
      successMessage: (data) => [
        ...
        imageMessage(`${LEVEL_ASSETS_PREFIX}關卡14_知識補充.jpg`)
      ]
    },
    {
      id: '15',
      ...
      successMessage: (data) => [
        ...
        imageMessage(`${LEVEL_ASSETS_PREFIX}/關卡15_知識補充.jpg`)
      ]
    },
    {
      id: '16',
    ...
    },
    {
      ...
      password: '新莊',
      errorMessage: [textMessage('答案就近在眼前')],
      successMessage: (data) => [
    ...
    },
    {
      ...
      successMessage: () => [
        ...
        imageMessage(`${LEVEL_MAHJONG_ASSETS_PREFIX}/LINE關卡圖片_麻將-新莊.png`)
      ]
    },
    {
      id: '20',
    ...
    },
    {
      ...
      successMessage: (data) => [
        ...
        imageMessage(`${LEVEL_MAHJONG_ASSETS_PREFIX}/LINE關卡圖片_麻將-新店.png`),
        textMessage(
    ...
    },
    {
      ...
      successMessage: () => [
        textMessage('答對了！\n🀄 恭喜獲得「樹林」麻將'),
        imageMessage(`${LEVEL_MAHJONG_ASSETS_PREFIX}/LINE關卡圖片_麻將-樹林.png`)
      ]
    },
    {
      id: '24',
      ...
      password: '沙盒樹單片外殼',
      errorMessage: [textMessage('找找看一個盒子')],
      successMessage: () => [
        textMessage('答對了！\n🀄 恭喜獲得「汐止」麻將'),
        imageMessage(`${LEVEL_MAHJONG_ASSETS_PREFIX}/LINE關卡圖片_麻將-汐止.png`)
      ]
    },
    {
      id: '25',
      ...
      successMessage: (data) => [
        textMessage('答對了！是櫻花、油桐花、令箭荷花、金瓜花共4種～\n🀄 恭喜獲得「土城」麻將'),
        imageMessage(`${LEVEL_MAHJONG_ASSETS_PREFIX}/LINE關卡圖片_麻將-土城.png`),
        textMessage(
    ...
    },
    {
      ...
      successMessage: (data) => [
        ...
        imageMessage(`${LEVEL_MAHJONG_ASSETS_PREFIX}/LINE關卡圖片_麻將-板橋.png`),
    ...
    },
    {
      ...
      successMessage: () => [
        ...
        imageMessage(`${LEVEL_MAHJONG_ASSETS_PREFIX}/LINE關卡圖片_麻將-永和.png`)
      ]
    }
  ],
  cards: {
    [Era.THE1950]: {
      [CardType.Chance]: {
        ...
        description:
          '一村的眷舍分為特/甲/乙/丙四個等級，特級是上校以上才能入住，其餘則按照眷屬人數進行分配。在擴建之前，一般眷舍12坪要擠四個人以上，特級則是擁有自己的獨棟和庭園；好奇的話，就到16號眷舍看看吧。',
        image: '機會1950.jpg'
      },
      [CardType.Destiny]: {
        isCanGetAward: true,
        ...
        description:
          '一村的眷舍分為特/甲/乙/丙四個等級，特級是上校以上才能入住，其餘則按照眷屬人數進行分配。在擴建之前，一般眷舍12坪要擠四個人以上，還要跟別戶共用廁所和水井。不過也是這樣大家才會關係這麼緊密吧。',
        image: '命運1950.jpg'
      }
    },
    [Era.THE1960]: {
      [CardType.Chance]: {
        ...
        description:
          '颱風來淹水怎麼辦？臺北盆地體質易淹水，日治時期就有多次淹水紀錄。經歷畢莉颱風、八七水災、葛樂禮颱風等造成的災情，民國50年代開始執行「台北防洪計畫」，蓋起二重疏洪道，以及幾乎包圍了淡水河的堤防等水利設施。',
        image: '機會1960.jpg'
      },
      [CardType.Destiny]: {
        isCanGetAward: true,
    ...
    [Era.THE1970]: {
      [CardType.Chance]: {
        ...
        description:
          '1970年代歷經退出聯合國、中美斷交大事件，台海局勢動盪不安。深知美援對台灣的重大影響，人們大多崇拜美國，此時掀起一波移民潮。部分外省家族因為有了「移民」到台灣的經歷，對於再次移民不排斥，為追求更安穩的生活，也選擇到美國落地生根。',
        image: '機會1970.jpg'
      },
      [CardType.Destiny]: {
        isCanGetAward: true,
        ...
        subtitle: '家人終於回家，好開心',
        description:
          '八二三砲戰對許多人也許只是課本上的敘述，對一村的村民卻是一場關乎前線家人死活的戰役。1979年美國和中華民國斷交，與中國建交，砲擊聲才終於消停。這也是國共之間最後一次大型軍事衝突。',
        image: '命運1970.jpg'
      }
    },
    [Era.THE1980]: {
    ...
    [Era.THE2000]: {
      [CardType.Chance]: {
        ...
        description:
          '保存運動對眷戶們而言，也是個重新整理、紀錄過往眷村生活機會。眾人齊力找出老照片、累積口述歷史，編纂回憶錄與影像展；舉辦全台首創的「工作假期」，進行文物整理建檔和房舍修復。一切的累積讓一村作為文史建築，終於得以被保留，成為今天大家能來自由探索的異世界空間。',
        image: '機會2000.jpg'
      },
      [CardType.Destiny]: {
        isCanGetAward: true,
...
export const isPasswordCorrect = (currentLevelId: string, password: string, classified?: RandomLevelClassified) => {
  ...
  if (level.type === LevelType.Random && classified) {
    return level.password[classified] ? true : false;
  }

  return false;
};

// export const activationCodeList = localGlobalData.levels.map((level) => level.activationCode);
